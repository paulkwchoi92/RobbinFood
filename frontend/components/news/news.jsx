...
class News extends React.Component {
  ...
  //         return (
  //           <div key={idx} >
  //             <a href={ele.url} className="news-item">
  //               <img src={ele.urlToImage} />
  //               <div className="news=right">
  //               {ele.source.id ? (
  //                 <div className="source">{ele.source.id}</div>
  //               ) : (
  //                 <div className="source">{ele.source.name}</div>
  //               )}
      ...
      <div id="news-container">
        ...
        <div className={this.state.showMore ? "news-items long" : "news-items"}>
          {news.map((article, i) => {
            ...
            return (<a key={i} href={article.url} className="news-item" color="black">
